...
<div
  class="flex min-h-full rounded-xl flex-col mx-auto max-w-2xl bg-[#2A313A] bg-repeat-round"
>
  <ol class="flex items-center w-full mb-4 ml-24 mt-2">
    <li
    ...
    >
      <div
        class="flex items-center justify-center w-10 h-10 bg-blue-100 rounded-full shrink-0"
      >
        <svg
          class="w-4 h-4 text-blue-600 lg:w-6"
          aria-hidden="true"
