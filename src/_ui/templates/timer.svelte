...
<div class="flex flex-row overflow-hidden w-full rounded-sm sm:rounded-lg bg-black my-2 pr-1 ring-1 ring-black">
  ...
  <div class="flex my-auto basis-2/3">
    {#key currentTime}
        <p class="mx-auto font-mono text-textWhite text-xs sm:text-base md:text-xl lg:text-2xl xl:text-3xl font-semibold">
