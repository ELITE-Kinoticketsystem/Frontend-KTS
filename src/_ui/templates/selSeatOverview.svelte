...
<div class="flex flex-col w-full h-full mx-auto mt-2">
  <p
  ...
  {#each distinctSeatsWithCount as seatWithCount}
    <div class="flex flex-row items-center mx-auto ring-1 ring-white rounded-lg">
      <p
        class="text-[2.5cqw] px-2 text-white "
      >
