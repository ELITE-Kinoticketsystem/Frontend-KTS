            ...
            {#if (!isLoggedIn)}
                ...
                <form>   
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" on:focus={onFocus} on:blur={onBlur} class="block p-2 ps-10 w-{searchbarSize} text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="{searchbarText}">
                    </div>
                </form>
            ...
            <div class="relative ml-3">
              <div>
                ...
                on:click={toggleDropdown}>
                  ...
                  <svg class="h-8 w-8 rounded-full bg-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
